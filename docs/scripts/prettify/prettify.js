...
;(function () {
  function L(a) {
    ...
    function y(a) {
      ...
      for (c = 1; c < d.length; ++c) d[c] === -1 && (d[c] = ++t)
      for (i = c = 0; c < b; ++c)
        (j = f[c]),
          j === '('
            ? (++i, d[i] === void 0 && (f[c] = '(?:'))
    ...
    function e(a) {
      switch (a.nodeType) {
        case 1:
          ...
          if (a.nodeName === 'BR') h(a), a.parentNode && a.parentNode.removeChild(a)
    ...
    try {
      ...
      for (d.length = r; h < p; ) {
        ...
        if (i.nodeType !== 1 && (j = t.substring(e, b))) {
          ...
          v.appendChild(i)
          e < o &&
            ((l[h + 1] = i = u.createTextNode(t.substring(b, o))), x.insertBefore(i, v.nextSibling))
        }
        e = b
        e >= o && (h += 2)
        e >= c && (a += 2)
