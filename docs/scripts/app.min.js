...
$().ready(function () {
  ...
  if (
    ...
    $('.vertical-section').each(function (e, a) {
      ...
      if (t) {
        ...
        i.find('.members h4.name').each(function (e, a) {
          ...
          s.append($('<li></li>').append(r)), c.push({ link: r, offset: i.offset().top })
        }),
          o.append(s)
      } else
        i.find('.members h4.name').each(function (e, a) {
    ...
    return o.hide()
  function e() {
    for (var e = n.scrollTop(), a = !1, i = c.length - 1; i >= 0; i--) {
      var t = c[i]
  ...
  $().ready(function () {
    $('#sidebarNav a').each(function (e, a) {
      ...
      window.location.pathname.match('/' + i) &&
        ($(a).addClass('active'), $('#sidebarNav').scrollTop($(a).offset().top - 150))
    })
  })
